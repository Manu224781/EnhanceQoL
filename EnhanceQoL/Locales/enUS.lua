...
L["combatLogAutoDesc"] = "Automatically start or stop combat logging when entering or leaving instances."
L["combatLogPrompt"] = "You have entered %s. Enable combat logging for this area?"
L["combatLogListDesc"] = "Enable entries here to automatically toggle combat logging for that instance and difficulty."
